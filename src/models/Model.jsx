...
export const generateContent = async (prompt, mode) => {
  ...
  try {
    const result = await model.generateContent(
      prompt +
        `Make the result ${mode} to AI detector. Make basic words only and don't change the context and length of the text and don't change the tone. Make the result like a hghschooler made it.`
    );
